...
abstract class AppColors {
  /// Primary Yellow
  static const Color primaryYellow = Color(0xFFF8CD5F);
  ...
  /// The dark aqua color.
  static Color overlayYellow = Colors.amber.shade200;
  ...
  static const Color mediumEmphasisSurface = Color(0x55000000);
